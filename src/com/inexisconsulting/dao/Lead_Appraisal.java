...
public class Lead_Appraisal {

	@Id
	@Column(name = "team_lead_appraisal_id")
	private int lead_appraisal_id;
	...
	public int getLead_appraisal_id() {
		return lead_appraisal_id;
	}

	public void setLead_appraisal_id(int lead_appraisal_id) {
		this.lead_appraisal_id = lead_appraisal_id;
	}
