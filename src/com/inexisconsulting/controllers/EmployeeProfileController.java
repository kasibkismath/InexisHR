...
public class EmployeeProfileController {
	...
	@RequestMapping(value = "/employeeProfile/employee/getEmployeeByEmpId", method = RequestMethod.POST, produces = "application/json")
	@ResponseBody
	public Employee getEmployeeByEmpId(@RequestBody Employee employee) throws ParseException {
		return employeeService.getEmployeeByEmpId(employee);
	}

	// get all emp history
	@RequestMapping(value = "/employeeProfile/employee/getEmpHistory", method = RequestMethod.GET, produces = "application/json")
	@ResponseBody
	public List<EmploymentHistory> getEmpHistory() {
		return employmentHistoryService.getEmpHistory();
	}

	// get emp history by empHistoryId
	@RequestMapping(value = "/employeeProfile/employee/getEmpHistoryById", 
			method = RequestMethod.POST, produces = "application/json")
	@ResponseBody
	public EmploymentHistory getEmpHistoryById(@RequestBody EmploymentHistory empHistory) {
		return employmentHistoryService.getEmpHistoryById(empHistory);
	}

	// update emp history
	@RequestMapping(value = "/employeeProfile/employee/updateEmpHistory", method = RequestMethod.POST, produces = "application/json")
	@ResponseBody
	public void updateEmpHistory(@RequestBody EmploymentHistory empHistory) throws ParseException {
		employmentHistoryService.updateEmpHistory(empHistory);
	}
	...
	@RequestMapping(value = "/employeeProfile/employee/disable", method = RequestMethod.POST, produces = "application/json")
	@ResponseBody
	public void disableEmployee(@RequestBody Employee employee) {
		employeeService.disableEmployee(employee);
	}

	@RequestMapping(value = "/employeeProfile/employee/getStatus", method = RequestMethod.POST, produces = "application/json")
	@ResponseBody
	public Employee getStatus(@RequestBody Employee employee) {
		return employeeService.getStatus(employee);
	}

	@RequestMapping(value = "/employeeProfile/MyProfile/getEmployee", method = RequestMethod.POST, produces = "application/json")
	@ResponseBody
