...
<!DOCTYPE html>
<html lang="en" ng-modules="leave, adminHeader">
<head>
<meta charset="utf-8">
...
<link
	href="${pageContext.request.contextPath}/static/css/Leave/leave.css"
	rel="stylesheet">
...
<body ng-controller="leaveMainController" ng-init="init()" ng-cloak>
	<!-- Header -->
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<ul class="nav nav-tabs" role="tablist">
						...
						<li role="presentation"><a href="#leave"
	...
	<script
			src="${pageContext.request.contextPath}/static/js/Leave/leaveAngular.js"></script>
</body>
</html>