...
<body ng-controller="trainingMainController" ng-init="init()" ng-cloak>
	...
	<sec:authorize access="hasAnyRole('ROLE_HR', 'ROLE_CEO', 'ROLE_ADMIN')">
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<ul class="nav nav-tabs" role="tablist">
						...
						<li role="presentation"><a href="#trainings"
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12">
					...
					<ul class="nav nav-tabs" role="tablist">
						<li role="presentation" class="active"><a href="#summary"
							aria-controls="home" role="tab" data-toggle="tab">My Training Summary</a></li>
						<li role="presentation"><a href="#myTrainings"
